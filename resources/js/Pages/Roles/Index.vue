            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row justify-between mb-4">
                        <form @submit.prevent="searchRoles" class="relative w-full sm:max-w-xs mb-4 sm:mb-0">
                            <input v-model="q" type="text" placeholder="Search roles..."
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-if="roles.data.length === 0">
                                    <td colspan="3"
                                        ...
                                        No roles found. Please try a different search.
                                    </td>
                                </tr>
...
const searchRoles = () => {
    router.get(route('roles.index'), { q: q.value }, {
        preserveState: true,
        onSuccess: (page) => {
