...
<template>
    ...
    <div
        class="relative flex flex-col min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-white"
    >
        <div v-if="canLogin" class="fixed top-0 right-0 p-6 text-end">
            <Link
                v-if="$page.props.auth.user"
                :href="route('dashboard')"
                class="font-semibold hover:text-gray-200 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
            >
                Dashboard</Link
            >
            ...
            <template v-else>
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="ml-4 font-semibold hover:text-gray-200 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >
                    Register</Link
                >
            </template>
        ...
        <div
            class="flex flex-col items-center justify-center flex-grow p-6 lg:p-8"
        >
            ...
            >
                <a
                    ...
                    class="p-6 bg-white dark:bg-gray-800/50 rounded-lg shadow-lg transform transition-transform hover:scale-105"
                >
                    <div
                        class="flex items-center justify-center h-16 w-16 bg-red-50 dark:bg-red-800/20 rounded-full"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
        ...
        >
            ...
            <div class="text-center text-sm text-gray-200 sm:text-end sm:ml-0">
